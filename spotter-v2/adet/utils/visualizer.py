...
class TextVisualizer(Visualizer):
    def __init__(self, image, metadata, instance_mode, cfg):
        ...
        if self.voc_size==96:
            ...
            self.custom_VOC_SIZE=96
        else:
            #russian
            if self.voc_size==110:
                self.custom_VOC_SIZE=110
            ...
            # with open(self.use_customer_dictionary, 'r') as fp:
            #     # print(self.use_customer_dictionary)
            #     lines=fp.readlines()
            #     len_dic=0
            #     label_dict_list=[]
            #     for ch in lines:
            #         # len_dic+=1
            #         ch.split('\n')
            #         label_dict_list.append(ch[0])
            # self.CTLABELS=label_dict_list 
    ...
    def _decode_recognition(self, rec):
        ...
        for c in rec:
            ...
            if c < self.voc_size - 1:
                if self.voc_size == self.custom_VOC_SIZE :
                    s += self.CTLABELS[c]
                else:
    ...
    def overlay_instances(self, ctrl_pnts, recs, scores, alpha=0.5):
        ...
        for ctrl_pnt, rec, score in zip(ctrl_pnts, recs, scores):
            ...
            self.draw_text(
                ...
                font_size=font_size,
                draw_chinese=False if self.voc_size == self.custom_VOC_SIZE else True
            )
