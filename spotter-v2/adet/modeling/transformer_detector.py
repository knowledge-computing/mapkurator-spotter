...
from adet.modeling.palejun.losses import SetCriterion
from adet.modeling.palejun.matcher import build_matcher
from adet.modeling.palejun.models import PALEJUN
...
class TransformerDetector(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.palejun = PALEJUN(cfg, backbone)
        ...
        self.criterion = SetCriterion(self.palejun.num_classes, box_matcher, point_matcher,
                                      weight_dict, enc_losses, dec_losses, self.palejun.num_ctrl_points, 
    ...
    def prepare_targets(self, targets):
        ...
        for targets_per_image in targets:
            ...
            gt_ctrl_points = raw_ctrl_points.reshape(-1, self.palejun.num_ctrl_points, 2) / torch.as_tensor([w, h], dtype=torch.float, device=self.device)[None, None, :]
