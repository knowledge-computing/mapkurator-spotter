...
class PALEJUN(nn.Module):
    ...
    def __init__(self, cfg, backbone):
        ...
        # this can be changed to two stage : layer wise
        ...
        self.transformer.decoder.ctrl_point_class = self.ctrl_point_class
        self.transformer.decoder.ctrl_point_coord = self.ctrl_point_coord
        self.transformer.decoder.text_class = self.text_class
        self.to(self.device)
    ...
    def forward(self, samples: NestedTensor):
        ...
        outputs, enc_outputs_class, enc_outputs_coord = self.transformer(
