...
class VisualizationDemo(object):
    ...
    def inference_on_image(self, image):
        ...
        Returns:
            predictions (dict): the output of the model.
            inference_output: a list of dict that contains polygon, text and score info
        """
        vis_output = None
        predictions = self.predictor(image)
        ...
        instances = predictions["instances"].to(self.cpu_device)
        poly_text_score_dict_list = visualizer.get_human_readable_prediction(predictions=instances)
        
        return predictions, poly_text_score_dict_list
